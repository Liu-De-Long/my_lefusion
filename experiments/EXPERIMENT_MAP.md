...
| `20260811_exp018_gli_exp016_pseudomask_lefusion` | 方法与对照实验 | 用 exp016 direct/置信度过滤四通道 mask 分别执行 exp010 FP32 全量训练 | mask、阈值、审计与双路线 preflight 已完成；direct 正式训练待启动 |
