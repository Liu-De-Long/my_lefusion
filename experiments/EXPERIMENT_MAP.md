...
| `20260807_exp010_gli_single_state_noise` | 方法实验 | 用单一完整 T1c 扩散状态消除跨通道捷径并预测噪声 | 5k/QA 已完成；双 GPU 长程训练在 step 28k 因 NaN 退出，冻结 step 14k best/EMA 运行 519 例 test 50% 双卡分片 |
