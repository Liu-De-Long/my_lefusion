...
| `20260807_exp013_gli_p64_multiscale_semisupervised_classifier` | 方法实验 | 在同一 1000 patch 上训练多尺度残差 3D U-Net，并用剩余 train patch 做 mean-teacher 半监督 | 全部 preflight 通过，准备监督训练；test 封存 |
