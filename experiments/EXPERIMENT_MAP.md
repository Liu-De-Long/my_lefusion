...
| `20260807_exp015_gli_p64_patient_component_balanced_classifier` | 方法实验 | 使患者、样本类别和连通组件训练权重与患者等权小区域指标对齐 | focused tests 20/20 与 CPU/GPU0 零步 preflight 通过；待启动 val-only 正式训练，test 封存 |
