...
| `20260807_exp015_gli_p64_patient_component_balanced_classifier` | 方法实验 | 使患者、样本类别和连通组件训练权重与患者等权小区域指标对齐 | epoch 9 后方法级 early stop；最佳 focus mIoU 0.5557，低于 exp014，性能门禁失败，test 封存 |
| `20260808_exp016_gli_p64_multimodal_classifier` | 方法实验 | 在同一冻结 1000 patch 与患者 split 上验证 T1c/T1n/T2f/T2w 四模态可分性 | 已完成 val；epoch 29 自然 early stop，best focus mIoU 0.6648，较 exp014 提升 0.0725，但未过 0.85，test 封存 |
